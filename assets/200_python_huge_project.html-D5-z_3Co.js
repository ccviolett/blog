import{_ as p}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as o,o as i,c,a as n,b as a,d as e,f as t}from"./app-CahC9Ikc.js";const l={},u=t(`<h1 id="python-大型项目开发" tabindex="-1"><a class="header-anchor" href="#python-大型项目开发" aria-hidden="true">#</a> Python 大型项目开发</h1><p>有一些 Python 的特性，只有当我们真正开发大型 Python 项目的时候，我们才能意识到他的重要性、意识到他存在的意义，而不是像在小型项目中一样只是炫技或者是玩具，比如“闭包”、“多线程”、”类型限制“等。</p><h2 id="绝对引用" tabindex="-1"><a class="header-anchor" href="#绝对引用" aria-hidden="true">#</a> 绝对引用</h2><p>假设我们写了一个配置文件在代码目录下，并且在代码中通过 <code>./config.yaml</code> 读取并使用了，那么恭喜你，当你的程序放在服务器上被其他的服务调用的时候，就会发生错误。</p><p>在代码中，对于所有引用文件都要使用“绝对调用”，保证在任何情况下调用我们的脚本都能够正常运行。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> os
script_dir <span class="token operator">=</span> os<span class="token punctuation">.</span>path<span class="token punctuation">.</span>dirname<span class="token punctuation">(</span>os<span class="token punctuation">.</span>path<span class="token punctuation">.</span>abspath<span class="token punctuation">(</span>os<span class="token punctuation">.</span>path<span class="token punctuation">.</span>realpath<span class="token punctuation">(</span>__file__<span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
config_file_path <span class="token operator">=</span> os<span class="token punctuation">.</span>path<span class="token punctuation">.</span>join<span class="token punctuation">(</span>script_dir<span class="token punctuation">,</span> <span class="token string">&#39;config.ini&#39;</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="多平台兼容" tabindex="-1"><a class="header-anchor" href="#多平台兼容" aria-hidden="true">#</a> 多平台兼容</h2><p>路径分隔符使用 <code>os.sep</code>，而不是硬编码写死 <code>/</code> 或 <code>\\</code>。</p><p>当然也可以使用 <code>os.path.join([path1, path2, path3])</code> 来实现。</p><h2 id="抽象" tabindex="-1"><a class="header-anchor" href="#抽象" aria-hidden="true">#</a> 抽象</h2><p>在 Python 面向对象编程中，静态函数和类函数不是一个概念。</p><p>静态函数装饰器 <code>staticmethod</code> 和抽象接口装饰器 <code>abstractmethod</code> 不能同时作用于同一个函数，但是类函数装饰器 <code>classmethod</code> 和抽象接口装饰器 <code>abstractmethod</code> 可以作用于同一个函数。</p><p>配合这一点，我们可以实现出其他语言难以实现的抽象——比如抽象类函数接口。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> abc
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="参考资料" tabindex="-1"><a class="header-anchor" href="#参考资料" aria-hidden="true">#</a> 参考资料</h3>`,15),r={href:"https://blog.csdn.net/qq_45779334/article/details/107858999",target:"_blank",rel:"noopener noreferrer"},d={href:"https://blog.csdn.net/qq_35844043/article/details/104862886",target:"_blank",rel:"noopener noreferrer"},k={href:"https://www.runoob.com/w3cnote/python-func-decorators.html",target:"_blank",rel:"noopener noreferrer"},v={href:"https://blog.csdn.net/qq_35844043/article/details/104862886",target:"_blank",rel:"noopener noreferrer"},m=t('<h2 id="闭包" tabindex="-1"><a class="header-anchor" href="#闭包" aria-hidden="true">#</a> 闭包</h2><h3 id="为什么需要闭包" tabindex="-1"><a class="header-anchor" href="#为什么需要闭包" aria-hidden="true">#</a> 为什么需要闭包？</h3><p>闭包的目的是为了实现更好的封装，可以提前设置一些非运行时的固定参数，并保留一些运行时参数延后传入，是函数的“预制菜”，可以让不同的接口展现出统一的特性。</p><p>比如现在我在做一个爬虫，我把每个网站的 POST 接口爬取下来，然后希望以后调用的时候，只要传入用户名和密码就可以调用特定网站的 POST 接口。</p><p>那么我可能首先写了一个脚本，将所有的 POST 接口爬取了下来，然后我可以在使用的时候，去写对应的 request 来请求这些 POST 接口。但我们也可以再 POST 接口爬取下来的时候就通过一个函数，生成一个调用这个接口的函数，这样之后我们就不用关心 request 请求的细节，只需要直接调用接口的函数即可。</p><p>即有通过一个函数 <code>generate_post_func</code>，参数是对应 POST 请求的一些固定参数，返回值是一个函数 <code>post_func</code>，该函数的参数是用户名和密码，可以让我们直接通过 <code>post_func(username, password)</code> 来得到请求返回的结果。</p><p>这个 <code>generate_post_func</code> 就是一个闭包。</p><h3 id="相关资料" tabindex="-1"><a class="header-anchor" href="#相关资料" aria-hidden="true">#</a> 相关资料</h3>',8),b={href:"https://blog.csdn.net/Saki_Python/article/details/136166366",target:"_blank",rel:"noopener noreferrer"},h=t(`<h2 id="多线程并发" tabindex="-1"><a class="header-anchor" href="#多线程并发" aria-hidden="true">#</a> 多线程并发</h2><h3 id="线程竞争并发示例" tabindex="-1"><a class="header-anchor" href="#线程竞争并发示例" aria-hidden="true">#</a> 线程竞争并发示例</h3><p>可以解决类似下面场景的问题：</p><p>有 n 个工作窗口，m 个客户，每个客户处理业务时会占用一个工作窗口。新建和关闭工作窗口的代价较大，即工作窗口需要一直保持在线，不能在完成单个客户的业务后关闭窗口，等下一个客户来时再新建窗口。当任意一个工作窗口空闲的时候，自动分配客户前往窗口处理业务。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> abc
...
<span class="token keyword">class</span> <span class="token class-name">ThreadingAssistantBasicClass</span><span class="token punctuation">(</span>metaclass<span class="token operator">=</span>abc<span class="token punctuation">.</span>ABCMeta<span class="token punctuation">)</span><span class="token punctuation">:</span>
    ...
    <span class="token keyword">def</span> <span class="token function">threading_run</span><span class="token punctuation">(</span>cls<span class="token punctuation">,</span> <span class="token operator">*</span>args<span class="token punctuation">,</span> <span class="token operator">**</span>kwargs<span class="token punctuation">)</span><span class="token punctuation">:</span>
        ...
        &quot;&quot;&quot;</span>
        <span class="token keyword">pass</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="参考资料-1" tabindex="-1"><a class="header-anchor" href="#参考资料-1" aria-hidden="true">#</a> 参考资料</h3>`,6),_={href:"https://blog.csdn.net/waple_0820/article/details/93026922",target:"_blank",rel:"noopener noreferrer"},y={href:"https://blog.csdn.net/Xiao_Liu_OvO/article/details/138716321",target:"_blank",rel:"noopener noreferrer"},g={href:"https://blog.csdn.net/qq_43380180/article/details/111573642",target:"_blank",rel:"noopener noreferrer"},f={href:"https://blog.csdn.net/qq_38962621/article/details/110767604",target:"_blank",rel:"noopener noreferrer"},w={href:"https://blog.csdn.net/qq_42830966/article/details/117842969",target:"_blank",rel:"noopener noreferrer"},q=t(`<h2 id="引用与封装" tabindex="-1"><a class="header-anchor" href="#引用与封装" aria-hidden="true">#</a> 引用与封装</h2><p>“数据向下引用，结果向上封装”，这是开发大型项目的时候一个很重要的观念。</p><h3 id="结果封装" tabindex="-1"><a class="header-anchor" href="#结果封装" aria-hidden="true">#</a> 结果封装</h3><p>使用类进行结果封装，而不是 <code>dict</code>，让上一级能够明确知道返回的结果有哪些内容，并且也能够为 IDE 提供补全提示。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">class</span> <span class="token class-name">Result</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="参考资料-2" tabindex="-1"><a class="header-anchor" href="#参考资料-2" aria-hidden="true">#</a> 参考资料</h3>`,13),x={href:"https://blog.csdn.net/lina_acm/article/details/54808910",target:"_blank",rel:"noopener noreferrer"},P=t(`<h2 id="超时限制" tabindex="-1"><a class="header-anchor" href="#超时限制" aria-hidden="true">#</a> 超时限制</h2><p>通常我们不希望我们的程序会在某一个 <code>case</code> 上卡死，导致我们需要在运行过程中重启我们的程序。</p><p>添加一个超时限制往往是一个不错的解决方法，我们使用 <code>func_timeout</code> 库来实现超时限制。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">from</span> func_timeout <span class="token keyword">import</span> func_set_timeout
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>但是上面这样的写法可能会存在问题，当 <code>my_dict</code> 中存在 <code>MyClass</code> 中未定义的 Key 时，就会发生 <code>TypeError</code>。</p><p>为了避免这种情况发生，我们可以在 <code>MyClass</code> 的初始化函数 <code>__init__</code> 中，添加 <code>**kwargs</code> 作为缓冲。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">class</span> <span class="token class-name">MyClass</span><span class="token punctuation">:</span>
    <span class="token keyword">def</span> <span class="token function">__init__</span><span class="token punctuation">(</span>self<span class="token punctuation">,</span> A<span class="token punctuation">,</span> B<span class="token punctuation">,</span> <span class="token operator">**</span>kwargs<span class="token punctuation">)</span><span class="token punctuation">:</span>
        ...
        self<span class="token punctuation">.</span>extra_params <span class="token operator">=</span> kwargs
...
my_object <span class="token operator">=</span> MyClass<span class="token punctuation">(</span><span class="token operator">**</span>my_dict<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6);function S(T,E){const s=o("ExternalLinkIcon");return i(),c("div",null,[u,n("ul",null,[n("li",null,[n("a",r,[a("python——class类和方法的用法详解_python class-CSDN博客"),e(s)])]),n("li",null,[n("a",d,[a("Python3之接口类（InterfaceClass）浅谈_python interface-CSDN博客"),e(s)])]),n("li",null,[n("a",k,[a("Python 函数装饰器 | 菜鸟教程 (runoob.com)"),e(s)])]),n("li",null,[n("a",v,[a("Python3之接口类（InterfaceClass）浅谈_python interface-CSDN博客"),e(s)])])]),m,n("ul",null,[n("li",null,[n("a",b,[a("一文教你Python中的闭包-CSDN博客"),e(s)])])]),h,n("ul",null,[n("li",null,[n("a",_,[a("python多线程(Multiprocessing)与多线程(Multithreading)区别优缺点最详细解释_python multiprocessing multithreading-CSDN博客"),e(s)])]),n("li",null,[n("a",y,[a("【Python】超详细实例讲解python多线程（threading模块）_python threading介绍-CSDN博客"),e(s)])]),n("li",null,[n("a",g,[a("python 异步 async/await_python async-CSDN博客"),e(s)])]),n("li",null,[n("a",f,[a("详解Python中的多线程、线程锁、线程变量 - threading、Thread、Lock与ThreadLocal详解_python thread variable-CSDN博客"),e(s)])]),n("li",null,[n("a",w,[a("【Python】threading控制线程的数量_threading控制线程数量-CSDN博客"),e(s)])])]),q,n("ul",null,[n("li",null,[n("a",x,[a("except as e中的‘e’的作用总结-CSDN博客"),e(s)])])]),P,n("ul",null,[n("li",null,[n("a",N,[a("Python超时装饰器：优雅地处理函数执行超时-CSDN博客"),e(s)])])]),C])}const M=p(l,[["render",S],["__file","200_python_huge_project.html.vue"]]);export{M as default};
