import{_ as p}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as o,o as i,c,a as n,b as a,d as e,f as t}from"./app-BxgDUf32.js";const l={},u=t(`<h1 id="python-大型项目开发" tabindex="-1"><a class="header-anchor" href="#python-大型项目开发" aria-hidden="true">#</a> Python 大型项目开发</h1><p>有一些 Python 的特性，只有当我们真正开发大型 Python 项目的时候，我们才能意识到他的重要性、意识到他存在的意义，而不是像在小型项目中一样只是炫技或者是玩具，比如“闭包”、“多线程”、”类型限制“等。</p><h2 id="多平台兼容" tabindex="-1"><a class="header-anchor" href="#多平台兼容" aria-hidden="true">#</a> 多平台兼容</h2><ul><li>路径分隔符 <code>os.sep</code>，而不是硬编码写死 <code>/</code> 或 <code>\\</code></li><li></li></ul><h2 id="抽象" tabindex="-1"><a class="header-anchor" href="#抽象" aria-hidden="true">#</a> 抽象</h2><p>在 Python 面向对象编程中，静态函数和类函数不是一个概念。</p><p>静态函数装饰器 <code>staticmethod</code> 和抽象接口装饰器 <code>abstractmethod</code> 不能同时作用于同一个函数，但是类函数装饰器 <code>classmethod</code> 和抽象接口装饰器 <code>abstractmethod</code> 可以作用于同一个函数。</p><p>配合这一点，我们可以实现出其他语言难以实现的抽象——比如抽象类函数接口。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> abc
